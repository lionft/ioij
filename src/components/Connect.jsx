...
const Connect = () => {
  ...
  const claimNFTs = () => {
    ...
    if (WalletAddress == TheOwnerAddress) {
      CONFIG.WEI_COST = 0;
    } else if (data.totalSupply > 1 && data.totalSupply < 5)
      CONFIG.WEI_COST = CONFIG.COST2;
    else if (data.totalSupply > 5 && data.totalSupply < 10)
      CONFIG.WEI_COST = CONFIG.COST0;
    else if (data.totalSupply > 10 && data.totalSupply < 14)
      CONFIG.WEI_COST = CONFIG.COST1;
    else if (data.totalSupply > 14 && data.totalSupply < 121)
      CONFIG.WEI_COST = CONFIG.COST3;
